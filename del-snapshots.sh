...
images_to_deregister=($(aws ec2 describe-images --owners <Insert your account number> --query 'Images[?CreationDate<`'"$__PASTDUE"'`].{ID:ImageId}'))
...
snapshots_to_delete=($(aws ec2 describe-snapshots --owner-ids <Insert your account number> --query 'Snapshots[?StartTime<`'"$__PASTDUE"'`].SnapshotId'))
